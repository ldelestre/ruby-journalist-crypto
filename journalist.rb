...
results = @data.select {|item| item =~ /[A-Z]/}
puts results.size


########################################################### match "_"
puts "Combien de _ dans tous les pseudos confondus ?"
results = @data.select {|item| item.include?("_")}.size
puts results
